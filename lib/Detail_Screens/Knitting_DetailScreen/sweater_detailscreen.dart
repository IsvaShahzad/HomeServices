...
class SweaterDetailScreen extends StatefulWidget {
  ...
  @override
  State<SweaterDetailScreen> createState() => _SweaterDetailScreenState();
}

class _SweaterDetailScreenState extends State<SweaterDetailScreen> {

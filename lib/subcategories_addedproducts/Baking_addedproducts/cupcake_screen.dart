...
class _CupcakeScreenState extends State<CupcakeScreen> {
  ...
  String getAppbarTitle() => "Cupcakes ";
        ...
        child: Scaffold(
            ...
            body: Padding(
              ...
              child: widget.added != null &&
                  widget.added['cupcakelist'] != null &&
                  widget.added['cupcakelist'].isNotEmpty
                  ? GridView.builder(
                itemCount: widget.added['cupcakelist'].length,
                ...
                itemBuilder: (context, index) {
                  final addedproductss = widget.added['cupcakelist'][index];
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (context) => CupcakeDetailScreen(

        ...
        child: Scaffold(
            ...
            body: Padding(
              ...
              child: widget.added != null &&
                  widget.added['cakelist'] != null &&
                  widget.added['cakelist'].isNotEmpty
                  ? GridView.builder(
                itemCount: widget.added['cakelist'].length,
                ...
                itemBuilder: (context, index) {
                  final addedproductss = widget.added['cakelist'][index];

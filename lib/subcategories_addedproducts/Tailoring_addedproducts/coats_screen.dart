...
import 'package:home_services_flutter/Detail_Screens/Tailoring_DetailScreen/coats_detailscreen.dart';
import 'package:home_services_flutter/initialScreens/loginScreen.dart';


class CoatsScreen extends StatefulWidget {
  final Map<String, dynamic> added;

  CoatsScreen({required this.added});

  @override
  _CoatsScreenState createState() => _CoatsScreenState();
}

class _CoatsScreenState extends State<CoatsScreen> {
  ...
  String getAppbarTitle() => "Tailored Coats ";
        ...
        child: Scaffold(
            ...
            body: Padding(
              ...
              child: widget.added != null &&
                  widget.added['coatslist'] != null &&
                  widget.added['coatslist'].isNotEmpty
                  ? GridView.builder(
                itemCount: widget.added['coatslist'].length,
                ...
                itemBuilder: (context, index) {
                  final addedproductss = widget.added['coatslist'][index];
                  ...
                  return InkWell(
                    ...
                    onTap: () {
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (context) => CoatsDetailScreen(

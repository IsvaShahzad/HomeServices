...
import 'package:home_services_flutter/Detail_Screens/Tailoring_DetailScreen/pants_detailscreen.dart';
...
class PantsScreen extends StatefulWidget {
  ...
  PantsScreen({required this.added});

  @override
  _PantsScreenState createState() => _PantsScreenState();
}
        ...
        child: Scaffold(
            ...
            body: Padding(
              ...
              child: widget.added != null &&
                  widget.added['pantslist'] != null &&
                  widget.added['pantslist'].isNotEmpty
                  ? GridView.builder(
                itemCount: widget.added['pantslist'].length,
                ...
                itemBuilder: (context, index) {
                  final addedproductss = widget.added['pantslist'][index];
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (context) => PantsDetailScreen(

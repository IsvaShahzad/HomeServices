...
import '../../Detail_Screens/Cooking_detail_screen/WesternDetailScreen.dart';
...
class _WesternScreenState extends State<WesternScreen> {
  ...
  String getAppbarTitle() => "Western products";
        ...
        child: Scaffold(
            ...
            body: Padding(
              ...
              child: widget.added != null &&
                  widget.added['Westernlist'] != null &&
                  widget.added['Westernlist'].isNotEmpty
                  ? GridView.builder(
                itemCount: widget.added['Westernlist'].length,
                ...
                itemBuilder: (context, index) {
                  final addedproductss = widget.added['Westernlist'][index];
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (context) => WesternDetailScreen(

...
class ScarfScreen extends StatefulWidget {
  final Map<String, dynamic> added;

  ScarfScreen({required this.added});

  @override
  _ScarfScreenState createState() => _ScarfScreenState();
}

class _ScarfScreenState extends State<ScarfScreen> {
  ...
  String getAppbarTitle() => "Knitted Scarfs";
        ...
        child: Scaffold(
            ...
            body: Padding(
              ...
              child: widget.added != null &&
                  widget.added['scarfslist'] != null &&
                  widget.added['scarfslist'].isNotEmpty
                  ? GridView.builder(
                itemCount: widget.added['scarfslist'].length,
                ...
                itemBuilder: (context, index) {
                  final addedproductss = widget.added['scarfslist'][index];

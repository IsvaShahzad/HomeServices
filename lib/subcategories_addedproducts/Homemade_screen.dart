...
class _HomemadeScreenState extends State<HomemadeScreen> {
  ...
  String getAppbarTitle() => "Home made products";
        ...
        child: Scaffold(
            ...
            body: Padding(
              ...
              child: widget.added != null &&
                  widget.added['Homemadelist'] != null &&
                  widget.added['Homemadelist'].isNotEmpty
                  ? GridView.builder(
                itemCount: widget.added['Homemadelist'].length,
                ...
                itemBuilder: (context, index) {
                  final addedproductss = widget.added['Homemadelist'][index];
